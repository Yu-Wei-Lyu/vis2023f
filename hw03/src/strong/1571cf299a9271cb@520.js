...
(width, height, offsetX, offsetY, scale) => {
  ...
  details
    ...
    .text((d) => {
      ...
      return `${d.properties.COUNTYNAME} ${foundData ? foundData.count : "無"}人`;
    });
...
d3.json("https://cdn.jsdelivr.net/npm/taiwan-atlas@2021.9.20/counties-10t.json")
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["UserData@1.json", {url: new URL("../json/UserData@1.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
